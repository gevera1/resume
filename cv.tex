...
\section{Education}
\subsection{Rensselaer Polytechnic Institute}{\large{ Troy, NY}}\\
{\large{\textbf{B.S. in Computer and Systems Engineering}, Awarded May 2022}}
\begin{tabbing}
    \hspace{1.5em} \textbf{GPA:} \hspace{3em} \= 3.42/4.00 \\
    \hspace{1.5em} \textbf{Clubs:} \> Rensselaer Electric Vehicle, Embedded Hardware Club, Engineers Without Borders
\end{tabbing}
